...
//
//	Shader lightingShader("lighting3.vs", "lighting3.frag");
...
//
//	lightingShader.use();
//	GLint materialDiffuseLocation = glGetUniformLocation(lightingShader.Program, "material.diffuse");//Âþ·´ÉäÌùÍ¼
