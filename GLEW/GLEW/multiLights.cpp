...
//
//	Shader lightingShader("lighting4.vs", "lightingM.frag");
...
//
//		glUniform3f(glGetUniformLocation(lightingShader.Program, "directionLight.direction"), -0.2f, -1.0f, -0.3f);
//		glUniform3f(glGetUniformLocation(lightingShader.Program, "directionLight.ambient"), 0.05f, 0.05f, 0.05f);
//		glUniform3f(glGetUniformLocation(lightingShader.Program, "directionLight.diffuse"), 0.4f, 0.4f, 0.4f);
//		glUniform3f(glGetUniformLocation(lightingShader.Program, "directionLight.specular"), 0.5f, 0.5f, 0.5f);
//
